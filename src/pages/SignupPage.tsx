...
export default function SignupPage({
  ...
  const factors = useMemo<LedgerFactor[]>(
    () => [
      { id: "email", label: "Email address", weight: 30, met: emailValid },
      {
        id: "password",
      ...
      {
        id: "acknowledged",
        label: "Demo acknowledgment",
        weight: 15,
        met: acknowledged,
      },
    ],
    [emailValid, passwordLongEnough, passwordsMatch, acknowledged],
  );

  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    if (isLoading || !passwordsMatch) return;
      ...
      >
        ...
        <div className="my-10 max-w-md lg:my-0">
          <h1 className="text-2xl font-semibold leading-snug tracking-tight sm:text-3xl">
            Your account, explained before it exists.
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            Inside the app, every risk score arrives with a per-patient SHAP
            breakdown of what pushed it up or down. This signup form holds
            itself to the same standard. Fill a field and its weight flips.
          </p>
          <div className="mt-6">
      ...
      <main className="flex items-center justify-center px-4 py-12 sm:px-8 lg:col-span-3">
        <div className="w-full max-w-md">
          ...
          <p className="mt-1.5 text-sm text-gray-600">
            Free, and every prediction comes with its reasoning.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-8">
            <div className="space-y-7">
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline justify-between">
                    ...
                    >
                      {passwordLongEnough ? "counted" : "pending"}
                    </span>
                  </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline justify-between">
                    ...
                    >
                      {passwordsMatch ? "counted" : "pending"}
                    </span>
                  </div>
                  <input
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-3.5 py-3">
                    <input
                      id="signup-acknowledge"
                      name="acknowledge"
                      type="checkbox"
                      required
                      ...
                      className="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
                    />
                    <label
                      htmlFor="signup-acknowledge"
                      className="text-sm leading-relaxed text-gray-700"
                    >
                      I understand NeuroRiskX is an educational demo, not a
                      medical device, and that its scores are not medical
                      advice.
                    </label>
                  </div>
                </div>
